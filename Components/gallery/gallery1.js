        ...
        <div>
          ...
          <div>
            <button
              ...
              data-src="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109613/StockingStuffers_trkfdn.jpg"
              className="button button--secondary"
            >
              Logo &amp; Branding
            </button>
          ...
          <div>
            <button
              ...
              data-src="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109611/BabyKtan_wdkm8p.jpg"
              className="button button--secondary"
            >
              Email Design
            </button>
          ...
          <div>
            <button
              ...
              data-src="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109613/PhotoGifts_Decor2_spazqm.jpg"
              className="button button--secondary"
            >
              Product Photography
            </button>
        ...
        <div className={style.gallerypackage}>
          <div className={style.part1}>
            <div className={style.col1}>
              <div className={style.item}>
                {/* <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109613/NT-full_oarpnz.jpg"> */}
                <Image
                  classname={style.img}
              ...
              <div className={style.item}>
                <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109613/NT-gif_hfuknj.gif">
                  <Image classname={style.img} src={img8} alt="" />
                </a>
              </div>

              <div className={style.item}>
                <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109611/BakingKit2_wo4jce.jpg">
                  <Image classname={style.img} src={img9} alt="" />
                </a>
              </div>

              <div className={style.item}>
                <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109611/EmailDesign3_yci188.jpg">
                  <Image classname={style.img} src={img10} alt="" />
                </a>
              </div>

              <div className={style.item}>
                <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109611/BabyKtan_wdkm8p.jpg">
                  <Image classname={style.img} src={img11} alt="" />
                </a>
              </div>

              <div className={style.item}>
                <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109612/MG2_dbfu83.jpg">
            ...
            <div className={style.col2}>
              <div className={style.item}>
                <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109612/myphoto1_xrw2ix.jpg">
                  <Image classname={style.img} src={img2} alt="" />
                </a>
              </div>

              <div className={style.item}>
                <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109612/MG1_qglj7z.jpg">
                  <Image classname={style.img} src={img1} alt="" />
                </a>
              </div>

              <div className={style.item}>
                <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109612/MG3_etovp1.jpg">
                  <Image classname={style.img} src={img13} alt="" />
                </a>
              </div>

              <div className={style.item}>
                <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109612/myphoto2_ge9dd7.jpg">
                  <Image classname={style.img} src={img14} alt="" />
                </a>
              </div>

              <div className={style.item}>
                <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109613/NomadTechy1_hjujkh.jpg">
          ...
          <div className={style.part2}>
            <div className={style.col3}>
              <div className={style.item}>
                <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109613/Thrive_StyleGuide_nbqcfl.jpg">
                  <Image classname={style.img} src={img6} alt="" />
                </a>
              </div>

              <div className={style.item}>
                <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109612/lights_july4_nwqxo1.jpg">
                  <Image classname={style.img} src={img3} alt="" />
                </a>
              </div>

              <div className={style.item}>
                <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109613/PhotoGifts_Decor1_bviqow.jpg">
                  <Image classname={style.img} src={img17} alt="" />
                </a>
              </div>

              <div className={style.item}>
                <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109613/PhotoGifts_Decor2_spazqm.jpg">
                  <Image classname={style.img} src={img18} alt="" />
                </a>
              </div>

              <div className={style.item}>
                <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109613/PhotoGifts_Decor3_jjerrd.jpg">
                  <Image classname={style.img} src={img19} alt="" />
                </a>
              </div>

              <div className={style.item}>
                <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109613/StockingStuffers_trkfdn.jpg">
                  <Image classname={style.img} src={img20} alt="" />
                </a>
              </div>

              <div className={style.item}>
                <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109614/vday_block_ojv1aj.gif">
            ...
            <div className={style.col4}>
              <div className={style.item}>
                <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109612/360block_lsnl5y.gif">
                  <Image classname={style.img} src={img4} alt="" />
                </a>
              </div>
              <div className={style.item}>
                <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109613/TheArtelleWebsite-blog_tm905p.jpg">
                  <Image classname={style.img} src={img7} alt="" />
                </a>
              </div>
              <div className={style.item}>
                <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109613/TheArtelle-blog_bltrhe.jpg">
              ...
              <div className={style.item}>
                <a href="https://res.cloudinary.com/dzpwjmq0x/image/upload/v1659109614/ThriveWomensConference_croglg.jpg">
